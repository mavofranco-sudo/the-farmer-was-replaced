...
def _reabastece():
	sementes = campo.n * campo.n
	custo_carrot = sementes * 512 + 512
	custo_wood = sementes * 2 + 50
	custo_hay = sementes * 2 + 50
	...
	if num_items(Items.Carrot) < custo_carrot:
		gerenciador.farma_recurso(Items.Carrot, custo_carrot)
